                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white shadow-sm sm:rounded-lg">
                        ...
                        <div class="p-6 text-gray-900">
                            {{ props.clients }}
                            <div v-if="props.clients.length === 0">Клиентов нет</div>
                            <div v-else class="client" v-for="client in props.clients" :key="client.id">
                                <div>
                                ...
                                <div>
                                    <InputLabel for="last_name" value="Ьенджер" />
                                    {{ client.manager_full_name }}
                                </div>
            ...
            <div class="py-12">
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white shadow-sm sm:rounded-lg">
                        <h2>Менеджеры</h2>
                        <div class="p-6 text-gray-900">
                            <div v-if="props.managers.length === 0">Менеджеров нет</div>
