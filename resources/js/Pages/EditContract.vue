                        ...
                        <div class="p-6 text-gray-900">
                            <form @submit.prevent="submit">
                                <div class="mt-4" >
                                    ...
                                    <select id="clients" v-model="form.user_id" required
                                ...
                                <div class="mt-4">
                                    ...
                                    <select id="deadline" v-model="selectedDuration" @change="handleDeadlineChange"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <option value="" disabled>{{ getYearDifference(form.create_date,form.deadline) === 1 ? getYearDifference(form.create_date,form.deadline) + ' год' : getYearDifference(form.create_date,form.deadline) + ' года' }}</option>
